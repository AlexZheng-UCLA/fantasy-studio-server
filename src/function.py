...
if __name__ == "__main__":
    ...
    img_source_dir = os.path.join("/root/autodl-tmp/sd-dataset", dataset)
    background_dir = "/root/fstudio/backgrounds"
    save_dir = os.path.join("/root/fstudio/output", dataset)
